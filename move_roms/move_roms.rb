...
Move ROMs 1.2
-------------
Moves ROMs files from the input directory or ZIP file to the specified output directory, given a ROM list generated by roms_filter.rb or arcade_roms_filter.rb.
...
File.open(romlist, "rt") do |f|
  f.each_line do |line|
    ...
    rom += '.zip' if File.extname(rom).empty?
    roms.push rom
    roms.each do |r|
      rom_total += 1
