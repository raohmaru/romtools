...
- [**mame-rom-name-finder**](https://github.com/raohmaru/mame-rom-name-finder)  
  Web application to get the MAME ROM names from a list of arcade games.
- [**game-box-3d**](https://github.com/raohmaru/game-box-3d)  
  Web application that renders game boxes in 3D and exports thumbnails.
- [**gamelist-query**](https://github.com/raohmaru/gamelist-query)  
  Search and filter games from gamelist.xml files.
